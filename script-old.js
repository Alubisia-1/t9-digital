...
const initializeFeatures = () => {
  // Essential functionality only for maximum performance
...
const initCounterAnimations = () => {
  ...
  counters.forEach(counter => {
    ...
    // Start counter immediately since animations are disabled
    updateCounter();
  });
};

// Simple skill bars initialization
const initSkillBars = () => {
...
const initAdvancedBackgroundEffects = () => {
  // Disabled all advanced effects for performance
  return;
};
